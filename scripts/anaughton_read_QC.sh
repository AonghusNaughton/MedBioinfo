...
srun bowtie-build -f ../data/reference_seqs/SARCoV_2_NC_045512.fna ../data/bowtie2_DBs/SARCoV2_bowtie2_DB
...
srun --cpus-per-task=8 bowtie2 -x ../data/bowtie2_DBs/SARCoV2_bowtie2_DB -U ../data/merged_pairs/ERR*.extendedFrags.fasta.gz \
